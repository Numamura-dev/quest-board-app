		...
		<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen flex flex-col">
			...
			<div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
				{Array.from({ length: 6 }).map((_, index) => (
					<div
						// biome-ignore lint/suspicious/noArrayIndexKey: スケルトン固定配列
...
const QuestList: React.FC = () => {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: user/isAuthenticated は認証状態変化時に再取得するために含める
	useEffect(() => {
