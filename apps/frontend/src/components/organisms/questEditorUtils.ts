...
export type QuestFormErrors = Partial<
	Record<
		"title" | "description" | "start_date" | "end_date" | "maxParticipants",
		string
	>
>;
...
export const sanitizePastedText = (input: string) =>
	input
		.replace(/\r\n/g, "\n")
		// biome-ignore lint/suspicious/noMisleadingCharacterClass: \u4E0D\u53EF\u8996\u6587\u5B57\u3092\u7BC4\u56F2\u6307\u5B9A\u3067\u9664\u53BB\u3059\u308B\u610F\u56F3\u7684\u306A\u6B63\u898F\u8868\u73FE
		.replace(/[\u200B-\u200D\uFEFF]/g, "")
		.replace(/[ \t]+\n/g, "\n")
		.replace(/\n{3,}/g, "\n\n")
		.replace(/[•●▪]/g, "-")
...
export const validateQuestForm = (formData: QuestFormData): QuestFormErrors => {
	...
	if (
		!Number.isFinite(formData.maxParticipants) ||
